...
### install from working directory (dev)

`sdgbuild build`

either method will first verify the dependencies, then ask you whether you want to use the stable managers.csv file or the dev file. 
...
once you've picked your managers file, it'll create your ~/.config/unipkg and ~/.local/unipkg directories, populate them, symlink the CLI into your /usr/bin folder and run the generate function to generate your initial unipkg.conf file. 
